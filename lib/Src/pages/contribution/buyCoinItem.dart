...
class BuyCoinItem extends StatefulWidget {
  String cashAmount;
  String volumeAmount;
  VoidCallback callback;

  BuyCoinItem({Key key, this.cashAmount, this.volumeAmount, this.callback}) : super(key: key);

  _BuyCoinItemState createState() => new _BuyCoinItemState();
}

class _BuyCoinItemState extends State<BuyCoinItem> {
  @override
